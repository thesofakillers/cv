...
\begin{rSection}{Education}
	...
	\begin{itemize}
		...
		\item Current thesis direction: Natural language interfaces for reward and/or goal specification in Reinforcement Learning
	\end{itemize}
...
\begin{rSection}{Experience}
	...
	\begin{itemize}\vspace{-0.5em}
		\item Working on efficient cross-lingual adaptation of multi-task monolingual prompt-enabled language models
	\end{itemize}
